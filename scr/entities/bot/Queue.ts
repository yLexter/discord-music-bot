...
import { MessageEmbed, ChatInputCommandInteraction } from 'discord.js';
import YouTube from "youtube-sr";
import { Song, Playlist, SpotifySong, SpotifyPlaylist } from "./Songs"
import { secondsToText } from ''
import {
    AudioPlayerStatus,
...
class Queue {
    ...
    public statusLoop 
    public delayButton 
    public lastClickButton 
    public amountPerPage 
    public randomQueue 
    public player 

    constructor(client: CustomClient, interaction: ChatInputCommandInteraction) {
